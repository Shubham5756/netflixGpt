  ...
  return (
    <div className="">
      ...
      <form
        ...
        className="bg-black p-10 absolute w-3/12  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col gap-4 text-white rounded-xl bg-opacity-95"
      >
